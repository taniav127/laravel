                    ...
                    <div class="card-body form-group">
                        <form method="POST" action="{{ route('subcategorias.update',$subcategoria->id) }}">
                            ...
                            <div class="table form-group">
                                ...
                                <input type="text" class="form-control" id="exampleText" name="nombre" value="{{$subcategoria->nombre}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">descripcion</label>
                                <input type="text" class="form-control" id="exampleInput" name="descripcion" value="{{$subcategoria->descripcion}}">
                            </div>
